...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/lang_cn.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBox_dest_lang.addItem(icon, "")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("images/lang_en.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("images/translate_google.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBox_trans_api.addItem(icon4, "")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("images/translate_youdao.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBox_trans_api.addItem(icon5, "")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("images/translate_baidu.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("images/lang_auto.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.comboBox_src_lang.addItem(icon7, "")
        self.comboBox_src_lang.addItem(icon, "")
